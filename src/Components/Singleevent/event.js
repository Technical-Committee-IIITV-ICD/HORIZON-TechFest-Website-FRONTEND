  ...
  let T6 = [
    {
      ...
      Rules: [
        ...
        "In case of any disputes, the decision of the organisers will be final and binding.",
        "Submission would begin from 17th Feb 9:00PM till 19th Feb 9:00PM."
      ],
      Themes: ["Agricultural Technology: Indian farmers face various challenges such as crop diseases, weather unpredictability, and market volatility. BTech students in computer science can aim to develope a platform that leverages technology such as IoT, machine learning, and data analysis to provide farmers with real-time information about crop health, weather patterns, and market prices. The solution could also include features such as precision agriculture, predictive maintenance, and digital wallets for farmers.","HealthTech: The Indian healthcare system faces various challenges such as inadequate infrastructure, shortage of doctors, and low access to medical services in rural areas. BTech students in computer science can aim to develop a platform for telemedicine that connects patients with doctors remotely and provides access to medical records and diagnostic tools. The solution could also include features such as e-prescriptions, appointment scheduling, and teleconsultation.","Education Technology: The quality of education and access to educational resources are major concerns in India, particularly in rural and remote areas. BTech students in computer science can aim to develop an education platform that connects students with online courses, virtual tutors, and educational resources. The solution could also include features such as online assessments, gamified learning, and personalized learning paths.","Clean Energy: India has a large dependence on fossil fuels, which contributes to air pollution and greenhouse gas emissions. BTech students in computer science can aim to develop a platform for clean energy that promotes the use of renewable energy sources and energy-efficient technologies. The solution could also include features such as real-time energy monitoring, demand response, and carbon credits trading.","Financial Inclusion: Many communities in India lack access to basic financial services, making it difficult for them to manage their finances and build wealth. BTech students in computer science can aim to develop a platform for financial inclusion that provides access to basic financial services, such as savings accounts, loans, and insurance. The solution could also include features such as digital wallets, microfinance, and savings groups.","Environmental Sustainability: India faces various environmental challenges such as air pollution, water scarcity, and waste management. BTech students in computer science can aim to develop a platform for environmental sustainability that leverages technology to address these issues. The solution could include features such as real-time air and water quality monitoring, waste management, and carbon credits trading.","Women's Safety: Women's safety is a major concern in India, particularly in urban areas. BTech students in computer science can aim to develop a platform for women's safety that leverages technology to enhance women's safety and empower women to take charge of their safety. The solution could include features such as panic buttons, real-time tracking, and community reporting.","Disaster Response: India is prone to natural disasters such as earthquakes, floods, and cyclones, which can cause widespread damage and displacement. BTech students in computer science can aim to develop a platform for disaster response that leverages technology to improve disaster response and relief efforts. The solution could include features such as real-time data analysis, resource allocation, and early warning systems.","Improving Healthcare Accessibility: Develop a platform that enables easy and efficient access to healthcare services, especially in rural areas. The platform should allow patients to connect with doctors, book appointments, and have access to their medical records. Desired solution: A user-friendly platform that integrates with existing healthcare systems, provides secure storage of medical records, and utilizes cutting-edge technologies such as AI and machine learning for disease diagnosis and treatment recommendations.","Reducing Agricultural Wastage: Develop a solution that reduces post-harvest losses in agriculture and helps farmers increase their profit margins. Desired solution: A smart storage system that monitors and regulates temperature and humidity to extend the shelf life of crops, an efficient transportation system that minimizes the time between harvesting and market delivery, and a market prediction system that helps farmers make informed decisions on when and what to plant based on demand and price.","Improving Educational Outcomes: Develop a platform that provides personalized learning experiences for students and improves educational outcomes. Desired solution: An AI-powered platform that provides customized lesson plans, assesses student progress, and adapts to each student's learning style, an integrated gamification system that makes learning more engaging and interactive, and a virtual classroom that enables students to learn from anywhere.","Reducing Environmental Footprint: Develop a solution that reduces an individual's carbon footprint and helps them make more sustainable choices. Desired solution: A mobile app that tracks an individual's daily activities and provides suggestions for reducing their carbon footprint, a virtual marketplace for sustainable products, and a system for offsetting carbon emissions.","Improving Public Safety: Develop a platform that improves public safety and emergency response times. Desired solution: An integrated emergency response system that connects first responders with each other and with the public, a real-time crime mapping system, and a community-based reporting system that enables the public to report incidents and receive updates on emergency response progress."],
      Register: 0,
      OutLink: 0
